<template>
  <div class="main-container page-2-1 px-5" id="particles-js">
    <div class="w-100 h-100">
      <div class="row header-container">
        <div class="col-12 page-header">
          <h1 class="pt-1 m-0 gradient-text font-weight-bold">三级页面1</h1>
        </div>
      </div>
      <div class="row content-container">
        <div class="col-3 d-flex flex-column align-items-center justify-content-center h-100">
          ...
          <div class="block-btns small-block mb-3">
          ...
          <div class="block-btns small-block">
            <div class="sub-header">3</div>
            <div class="row">
              <div class="col">
        ...
        <div class="col-6 d-flex flex-column align-items-center justify-content-around h-100">
          <div class="row model-container w-100">
            <div class="col-1"></div>
            <div class="col-10 flex-column justify-content-end">
              <img src="~assets/img/model-3.png" class="w-100">
              <div class="row">
                <div class="col d-flex flex-column justify-content-center align-items-center top">
...
<style lang="scss">
  .main-container.page-2-1 {
    ...
    .content-container {
      ...
      .comment-container {
        height: 30%;
        background-image: url('~assets/img/bg-block-7.png');
        background-size: 100% 100%;
        .col-2 {
          display: flex;
          ...
          .line-number {
            ...
            &.blue {
              color: #00eaff;
              &.first {
                border-bottom: solid 1px #00eaff;
              }
            }
            &.yellow {
              color: #ebbe35;
            ...
            &.purple {
              color: #bc30ea;
              &.first {
                border-bottom: solid 1px #bc30ea;
              }
            }
            &.green {
              color: #14e362;
              &.first {
                border-bottom: solid 1px #14e362;
              }
            }
          }
        }
